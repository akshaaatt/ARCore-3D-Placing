...
class PlaneRenderer(render: SampleRender?) {
    ...
    fun drawPlanes(
        ...
        sortedPlanes.sortWith { a, b -> b.distance.compareTo(a.distance) }
     ...
     */
    init {
        val texture = Texture.createFromAsset(render!!, TEXTURE_NAME, Texture.WrapMode.REPEAT, Texture.ColorFormat.LINEAR)
