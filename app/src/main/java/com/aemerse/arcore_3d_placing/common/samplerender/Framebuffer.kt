package com.aemerse.arcore_3d_placing.common.samplerender
...
import com.aemerse.arcore_3d_placing.common.samplerender.Texture.WrapMode
...
class Framebuffer(render: SampleRender?, width: Int, height: Int) : Closeable {
    ...
    override fun close() {
        if (framebufferId[0] != 0) {
            ...
            GLError.maybeLogGLError(Log.WARN,
                TAG,
