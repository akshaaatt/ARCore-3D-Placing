...
import com.aemerse.arcore_3d_placing.common.helpers.SnackbarHelper
import com.aemerse.arcore_3d_placing.common.helpers.TapHelper
...
class HelloArView(val activity: HelloArActivity) : DefaultLifecycleObserver {
  ...
  val snackbarHelper = SnackbarHelper().apply {
    this.setParentView(surfaceView)
  }
  ...
  private fun launchInstantPlacementSettingsMenuDialog() {
    ...
    AlertDialog.Builder(activity)
      ...
      .setPositiveButton(R.string.done) { _, _ ->
        ...
        activity.instantPlacementSettings.setInstantPlacementEnabled(checked[0])
